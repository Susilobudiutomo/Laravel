    ...
    <div class="row justify-content-center">
        <div class="col-lg-5">
            <main class="form-registration w-100 m-auto">
                <h1 class="text-center mb-3 mt-5 ">Regitser Now</h1>
...
unset($__errorArgs, $__bag); ?>
                ...
                <small class="d-block text-center mt-2">Alredy Registerd? <a href="/login" class="text-decoration-none"> login Now!</a></small>
              </main>
-        </div>
    </div>             
    </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\coba-laravel\resources\views/register/index.blade.php ENDPATH**/ ?>